...
function initApp(){
    products.forEach((value, key) =>{
        ...
        console.log(NV_STATIC_URL, TEMPLATE);
        newDiv.innerHTML = `
            <a href="product_details.html">
                <div class="product">
                    <img src="${NV_STATIC_URL}themes/${TEMPLATE}/assets/images/products/${value.image}" alt="">
                    <div class="product-text">
                        <li>${value.name}</li>
                        <li><img src="${NV_STATIC_URL}themes/${TEMPLATE}/assets/images/products/item1.png" alt="">Online giá rẻ quá</li>
                        <li>
...
function reloadCard(){
    ...
    listCards.forEach((value, key)=>{
        ...
        if(value != null){
            ...
            newDiv.innerHTML = `
                <div><img src="${NV_STATIC_URL}themes/${TEMPLATE}/assets/images/products/${value.image}"/></div>
                <div>${value.name}</div>
