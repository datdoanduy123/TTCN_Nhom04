...
<head>
    ...
    <link rel="stylesheet" href="{NV_STATIC_URL}themes/{TEMPLATE}/assets/css/Thang.css">
    <link rel="stylesheet" href="{NV_STATIC_URL}themes/{TEMPLATE}/assets/css/Hoang.css">
    <link rel="stylesheet" href="{NV_STATIC_URL}themes/{TEMPLATE}/assets/css/Chinh.css">
...
<body>
        ...
        <div id="topdemo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets//images/anhduan1.webp" alt="">
                </div>
                <div class="carousel-item">
                    <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets//images/anhbanner2.webp" alt="">
                </div>
                <div class="carousel-item">
                    <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets//images/anhbanner3.webp" alt="">
                </div>
                <div class="carousel-item">
                    <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets//images/anhbanner4.webp" alt="">
                </div>
            </div>
    ...
    <div class="khoitong1">
        ...
        <div class="tong2">
            <div id="demo" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets//images/anh1.png" alt="" class="d-block" style="width:1000px" height="300px">
                    </div>
                    <div class="carousel-item">
                        <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets//images/anh2.png" alt="" class="d-block" style="width:1000px" height="300px">
                    </div>
                    <div class="carousel-item">
                        <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets//images/anh3.png" alt="" class="d-block" style="width:1000px" height="300px">
                    </div>
                    <div class="carousel-item">
                        <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh4.png" alt="" class="d-block" style="width:1000px" height="300px">
                    </div>
                    <div class="carousel-item">
                        <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh5.png" alt="" class="d-block" style="width:1000px" height="300px">
                    </div>
                    <div class="carousel-item">
                        <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh6.png" alt="" class="d-block" style="width:1000px" height="300px">
                    </div>
                    <div class="carousel-item">
                        <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh7.png" alt="" class="d-block" style="width:1000px" height="300px">

                    </div>
                    <div class="carousel-item">
                        <img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh8.png" alt="" class="d-block" style="width:1000px" height="300px">
                    </div>
            ...
            <div class="tong2phai">
                <a href="#"><img style="padding-bottom: 10px;" src="{NV_STATIC_URL}themes/{TEMPLATE}/assets//images/anh9.png" alt=""></a>
                <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets//images/anh10.png" alt=""></a>
            </div>
        </div>
        <div class="tong3">
            <div class="dropdown">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <div class="bodershow">
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh1.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh2.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh3.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh4.jpg " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh5.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh6.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh7.jpg " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh8.jpg " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh9.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh10.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh11.jpg " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh12.jpg " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh13.jpg " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh14.jpg " alt=""></a>
                    </div>
                </div>
            </div>
            <div class="dropdown">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <div class="bodershow2">
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh15.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh16.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh17.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh18.png " alt=""></a>
                        <a href=""><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhmenu/anh19.png " alt=""></a>
            ...
            <div class="khoi24">
                <div class="khoi24tren">
                    <div>
                        ...
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anhzl.webp" alt=""> Zalo TGDĐ</a>
                    </div>
                    <div class="anhdautu">
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh241.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh242.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh243.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh244.png" alt=""></a>
                ...
                <div class="khoi24duoi">
                    ...
                    <div class="anhtapdoan">
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh245.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh246.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh247.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh248.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh249.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh2450.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh2451.png" alt=""></a>
                        <a href="#"><img src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/images/anh2452.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{NV_STATIC_URL}themes/{TEMPLATE}/assets/js/Thegioididong.js"></script>
</body>
